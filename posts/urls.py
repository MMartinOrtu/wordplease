...
from posts.api import PostListAPIView, PostDetailAPIView, UserPostsListAPIView
from posts.views import HomeView, PostDetailView, NewPostView, UserPostsListView
